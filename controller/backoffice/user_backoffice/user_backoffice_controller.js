...
module.exports = {
  View: async (req, res) => {
    ...
    try {
      resp = await ExeQuery(`CALL user_backoffice_view(?,?,?,?)`, [
        "%" + (search || "") + "%",
        start,
        limit,
        req.userModel?.id,
  ...
  Create: async (req, res) => {
    ...
    try {
      resp = await ExeQuery(`CALL user_backoffice_insert(?,?,?,?,?,?,?,?,?)`, [
        ...Object.values(body),
        req.userModel?.id,
      ]);
      resp = {
  ...
  Delete: async (req, res) => {
    ...
    try {
      resp = await ExeQuery(`CALL user_backoffice_delete(?,?)`, [
        body.id,
        req.userModel?.id,
      ]);
  ...
  ChangePass: async (req, res) => {
    ...
    try {
      resp = await ExeQuery(`CALL user_backoffice_change_pass(?,?,?)`, [
        ...Object.values(body),
        req.userModel?.id,
      ]);
  ...
  Update: async (req, res) => {
    ...
    try {
      resp = await ExeQuery(`CALL user_backoffice_update(?,?,?,?,?,?,?,?,?)`, [
        ...Object.values(body),
        req.userModel?.id,
      ]);
